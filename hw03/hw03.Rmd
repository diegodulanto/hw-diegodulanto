...
green_histo <- ggplot(green_rescale) +
  aes(x = green_pomp) +
  geom_histogram(fill = "red",
                 bins = 25)+
  theme_classic()

intel_histo  <- ggplot(green_rescale) +
  aes(x = intel_pomp) +
  geom_histogram(fill = "green",
                 bins = 25)+
  theme_classic()

comp_histo <- ggplot(green_rescale) +
  aes(x = comp_pomp) +
  geom_histogram(fill = "blue",
                 bins = 25)+
  theme_classic()

open_histo <- ggplot(green_rescale) +
  aes(x = open_pomp) +
...
## The graphs show that these four variables have relatively normal distribution. The data tells us that, for comp and open, their distribution are slightly skewed left.
