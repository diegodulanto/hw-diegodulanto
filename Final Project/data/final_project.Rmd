...
colombia_averages <- immigrant_data %>%
  ...
  summarise(
    ...
    col_YoA = Mode(Year_of_Admission, na.rm = TRUE))
...
peru_averages <- immigrant_data %>%
  ...
  summarise(
    ...
    peru_YoA = Mode(Year_of_Admission, na.rm = TRUE))

ecuador_averages <- immigrant_data %>%
  filter(Country_of_Birth == 227) %>%
  summarise(
    ec_age = mean(Age, na.rm = TRUE),
    ec_MoA = Mode(Month_of_Admission, na.rm = TRUE),
    ec_YoA = Mode(Year_of_Admission, na.rm = TRUE))
  

print(colombia_averages)
print(peru_averages)
print(ecuador_averages)
```
